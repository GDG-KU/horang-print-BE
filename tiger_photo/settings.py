...
_default_gcs_prefix = f"https://storage.googleapis.com/{GCS_BUCKET_NAME}" if GCS_BUCKET_NAME else ""
GCS_PUBLIC_URL_PREFIX = os.getenv("GCS_PUBLIC_URL_PREFIX", _default_gcs_prefix)
